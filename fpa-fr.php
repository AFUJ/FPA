...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr-fr" lang="fr-fr" >
	...
	if (defined('_FPA_BRA')) {
		define('_RES', 'Assistant Rapport de Bogue forum.joomla.fr');
		define('_RES_withUrl', 'Assistant Rapport de Bogue <a href="//forum.joomla.fr" target="_blank">forum.joomla.fr</a>');
	} else {
		define('_RES', 'Assistant aux messages du forum Joomla.fr');
		define('_RES_withUrl', 'Assistant aux messages du <a href="//forum.joomla.fr" target="_blank">forum.joomla.fr</a>');
	}
	...
	et sous licence GNU GPLv3 ou supérieure. Vous êtes invité à le redistribuer sous certaines conditions.
	Pour plus de détails lire le fichier LICENSE.txt inclus dans le package de téléchargement avec ce script.
	Une copie de la licence peut également être obtenu à');
	...
	define('_PHP_DISERR', 'Affichage des erreurs PHP activé');
	define('_PHP_ERRREP', 'Rapport d\'erreur PHP activé');
	define('_PHP_LOGERR', 'Les erreurs PHP sont en cours d\'enregistrement dans un fichier');
	// section titles & developer-mode array names
	define('_FPA_SNAP_TITLE', 'Environment Support Snapshot');
	define('_FPA_INST_TITLE', 'Instance d\'Application');
	define('_FPA_SYS_TITLE', 'Environnement système');
	define('_FPA_PHP_TITLE', 'Environnement PHP');
	define('_FPA_PHPEXT_TITLE', 'Extensions PHP');
	define('_FPA_PHPREQ_TITLE', 'PHP Requis');
	define('_FPA_APAMOD_TITLE', 'Modules Apache');
	define('_FPA_APAREQ_TITLE', 'Apache Requis');
	define('_FPA_DB_TITLE', 'Instance de base de données');
	define('_FPA_TABLE', 'Tables');
	define('_FPA_DBTBL_TITLE', 'Structure des Tables');
	define('_FPA_PERMCHK_TITLE', 'Vérification des droits');
	define('_FPA_COREDIR_TITLE', 'Répertoires Core');
	define('_FPA_ELEVPERM_TITLE', 'Privilèges');
	define('_FPA_EXTCOM_TITLE', 'Composants');
	...
	//
	define('_FPA_SUPPHP', 'Support PHP');
	define('_FPA_SUPSQL', 'Support MySQL');
	define('_FPA_BADPHP', 'Bugs connus de PHP');
	define('_FPA_BADZND', 'Bugs connus de Zend');
	// slow screen message
	//
	define('_FPA_SLOWGENPOST', 'Génération du message...');
	define('_FPA_SLOWRUNTEST', 'Accrochez-vous pendant que nous effectuons des tests...');

	// remove script notice content - Phil 4-17-12
	define('_FPA_DELNOTE_LN1', '<h3><p /><font color="#FF0000" size="2">** INFORMATIONS DE SECURITE **</font color></size></h3><p /><font size="1">En raison de la nature très sensible de l\'information affichée par le script FPA,<p /> il doit être supprimé du serveur immédiatement après son utilisation.</font>');
	define('_FPA_DELNOTE_LN2', '<p /><font size="1">  Si le script est laissé sur le site, il peut être utilisé pour recueillir suffisamment d\'informations pour pirater votre site.</font>');
	define('_FPA_DELNOTE_LN3', '<p /><font color="#FF0000" size="3" ;">Après utilisation, <a href="fpa-fr.php?act=delete">Cliquer ici</a>  pour effacer ce script.</font>');

	// dev/diag-mode content
	define('_FPA_DEVMI', 'developer-mode-information');
	define('_FPA_ELAPSE', 'elapse-runtime');
	define('_FPA_DEVENA', 'MODE DEVELOPPEUR est activé');
	...
	define('_FPA_DIAERR', 'Last DIAGNOSTIC MODE Error');
	define('_FPA_SPNOTE', 'Note spéciale');
	// user post form content
	define('_FPA_INSTRUCTIONS', 'Instructions');
	define('_FPA_INS_1', 'Saisissez la description de votre problème <i>(option)</i>');
	define('_FPA_INS_2', 'Saisissez les messages d\'erreurs que vous avez eu <i>(option)</i>');
	define('_FPA_INS_3', 'Entrer toutes les actions prises pour résoudre le problème <i>(option)</i>');
	define('_FPA_INS_4', 'Sélectionner les options Run-Time <i>(option)</i>');
	define('_FPA_INS_5', 'Cliquer sur le bouton <span class="normal-note">Cliquer ici pour générer le message</span> pour créer le contenu du message');
	define('_FPA_INS_5b', 'Cliquer sur le bouton ci-dessus pour générer le contenu du message');
	define('_FPA_INS_6', 'Copier le contenu du cadre <span class="ok-hilite">&nbsp;descriptif du message&nbsp;</span> et coller suivant les instructions'); //changed wording Phil 4-20-12
	define('_FPA_INS_7', ' <div align="center"><font size="2">Pour copier le contenu du cadre descriptif du message:
  </font></div>
  <p align="left" />
  <div align="left"><font size="2">1.) Placez le curseur dans le tableau ci-dessus du message généré,</font></div>
<p align="left" />
  <div align="left"><font size="2">2.) Utilisez CTRL-a pour sélectionner tout le texte du cadre</font></div>
<p align="left" />
  <div align="left"><font size="2">3.) Utilisez CTRL-c pour copier le texte généré pour le presse-papiers du navigateur.</font></div>
<p align="left" />
  <div align="left"><font size="2">4.) Utiliser CTRL-v pour coller le texte copié dans votre message du forum à l\'endroit désiré.</font></div>'); //added instruction lines Phil 4-20-12
	define('_FPA_POST_NOTE', 'Laissez tous les champs vides après diagnostic.');
	define('_FPA_PROB_DSC', 'Description du problème');
	define('_FPA_PROB_MSG', 'Message d\'erreur/log');
	define('_FPA_PROB_ACT', 'Actions prises pour corriger');
	define('_FPA_PROB_CRE', 'Actions prises pour recréer les conditions');
	define('_FPA_OPT', 'Paramètres optionnels');
	define('_FPA_SHOWELV', 'Afficher les droits d\'accès aux répertoires');
	define('_FPA_SHOWDBT', 'Afficher les statistiques de base de données');
	define('_FPA_SHOWCOM', 'Afficher les Composants');
	define('_FPA_SHOWMOD', 'Afficher les Modules');
	define('_FPA_SHOWPLG', 'Afficher les Plugins');
	define('_FPA_INFOPRI', 'Informations Privées');
	define('_FPA_SHOWCEX', 'Afficher les extensions core');
	define('_FPA_PRIVNON', 'Non');
	...
	define('_FPA_OUTMEM', 'Dépassement de mémoire');
	define('_FPA_OUTTIM', 'Temps d\'exécution dépassé');
	define('_FPA_INCPOPS', 'Augmenter temporairement la mémoire PHP et le temps d\'exécution');
	define('_FPA_POSTD', 'Descriptif du message');

	/** common screen and post output strings *********************************************** */
	define('_FPA_APP', 'Joomla!');
	define('_FPA_INSTANCE', 'Instance');
	define('_FPA_PLATFORM', 'Platforme');
	define('_FPA_DB', 'Base de données');
	define('_FPA_SYS', 'Système');
	define('_FPA_SERV', 'Serveur');
	define('_FPA_CLNT', 'Client');
	define('_FPA_HNAME', 'Serveur');
	define('_FPA_DISC', 'Détails');
	define('_FPA_LEGEND', 'Légendes et paramètres');
	define('_FPA_GOOD', 'OK/BON');
	define('_FPA_WARNINGS', 'ATTENTION');
	define('_FPA_ALERTS', 'ALERTES');
	...
	define('_FPA_OF', 'de');
	define('_FPA_TO', 'vers');
	define('_FPA_FOR', 'pour');
	define('_FPA_IS', 'est');
	define('_FPA_AT', 'chez');
	define('_FPA_IN', 'dans');
	define('_FPA_BUT', 'mais');
	define('_FPA_LAST', 'Dernier');
	define('_FPA_NONE', 'Non');
	define('_FPA_DEF', 'défaut');
	define('_FPA_Y', 'Oui');
	define('_FPA_N', 'Non');
	define('_FPA_FIRST', 'Premiers');
	define('_FPA_M', 'Peut-être');
	define('_FPA_U', 'Inconnu');
	define('_FPA_K', 'Connu');
	define('_FPA_E', 'Existe');
	define('_FPA_JCORE', 'Core');
	define('_FPA_3PD', 'Élément Tiers');
	define('_FPA_TESTP', 'tests performed');
	define('_FPA_DNE', 'N\'existe pas');
	define('_FPA_F', 'Trouvé');
	define('_FPA_NF', 'Introuvable');
	define('_FPA_OPTS', 'Options');
	define('_FPA_CF', 'Configuration');
	define('_FPA_CFG', 'Configuration');
	define('_FPA_YC', 'Configuré');
	define('_FPA_NC', 'Non Configuré');
	define('_FPA_ECON', 'Erreur de Connexion');
	define('_FPA_CON', 'Connecter');
	define('_FPA_YCON', 'Connecté');
	define('_FPA_CONT', 'Type de connexion');
	define('_FPA_NCON', 'Non Connecté');
	define('_FPA_SUP', 'support');
	define('_FPA_YSUP', 'supporté');
	define('_FPA_DROOT', 'Doc Racine');
	define('_FPA_NSUP', 'non supporté');
	define('_FPA_NOA', 'Non-tenté');
	define('_FPA_NER', 'Aucune erreur signalée');
	define('_FPA_ER', 'erreur(s) enregistrée(s)');
	define('_FPA_ERR', 'erreur');
	define('_FPA_ERRS', 'erreurs');
	define('_FPA_YMATCH', 'Correspond');
	define('_FPA_NMATCH', 'Mis-Match');
	define('_FPA_NACOMP', 'Apparament incomplet');
	define('_FPA_YACOMP', 'Apparament complet');
	define('_FPA_SEC', 'Securité');
	define('_FPA_FEAT', 'Fonctionnalités');
	define('_FPA_PERF', 'Performance');
	define('_FPA_NA', 'Néant');
	define('_FPA_CRED', 'Crédits');
	...
	define('_FPA_TNAM', 'Nom');
	define('_FPA_TSIZ', 'Taille');
	define('_FPA_TENG', 'Moteur');
	define('_FPA_TCRE', 'Créé');
	define('_FPA_TUPD', 'Mis à jour');
	define('_FPA_TCKD', 'Vérifié');
	define('_FPA_TCOL', 'Collation');
	define('_FPA_CHARS', 'Character Set');
	define('_FPA_TFRA', 'Taille Fragment');
	define('_FPA_AUTH', 'Auteur');
	define('_FPA_ADDR', 'Adresse');
	define('_FPA_STATUS', 'Statut');
	define('_FPA_TYPE', 'Type');
	define('_FPA_TREC', 'Rcds');  // Number of table records
	define('_FPA_TAVL', 'Long. Moyenne');
	define('_FPA_MODE', 'Mode');
	define('_FPA_WRITABLE', 'Autorisé en écriture');
	define('_FPA_RO', 'Lecture uniquement');
	define('_FPA_FOLDER', 'Répertoire');
	define('_FPA_FILE', 'Fichier');
	define('_FPA_OWNER', 'Propriétaire');
	define('_FPA_GROUP', 'Groupe');
	define('_FPA_VER', 'Version');
	define('_FPA_CRE', 'Crée');
	define('_FPA_LOCAL', 'Local');
	define('_FPA_REMOTE', 'Distant');
	define('_FPA_SECONDS', 'secondes');
	define('_FPA_TBL', 'Table');
	define('_FPA_STATS', 'Statistiques');
	define('_FPA_BASIC', 'Basique');
	define('_FPA_DETAILED', 'Détail');
	define('_FPA_ENVIRO', 'Environnement');
	define('_FPA_VALID', 'Valide');
	define('_FPA_NVALID', 'Non Valide');
	define('_FPA_EN', 'Activé');
	define('_FPA_DI', 'Désactivé');
	define('_FPA_NO', 'Non');

	define('_FPA_POTOI', 'Questions relatives à la propriété potentielle');
	define('_FPA_POTME', 'Extensions potentiellement manquantes');
	define('_FPA_POTMM', 'Modules potentiellement manquants');
	define('_FPA_DBCONNNOTE', 'n\'est peut-être pas une erreur, vérifiez auprès de l\'hôte les exigences d\'accès à distance.');
	define('_FPA_DBCREDINC', 'Credits incomplet ou non disponible');
	define('_FPA_MISSINGCRED', 'Missing credentials detected');
	define('_FPA_NODISPLAY', 'rien à afficher.');
	define('_FPA_EMPTY', 'doit être vide');
	define('_FPA_UINC', 'increased by user, was');
	define('_PHP_VERLOW', 'Version PHP trop lente');
	define('_FPA_SHOW', 'Afficher');
	define('_FPA_HIDE', 'Cacher');
	define('act', '');
	define('_FPA_MVFW', 'Plus d\'une instance de version.php trouvée !');
	define('_FPA_MVFWF', 'Multiple trouvé');
	define('_FPA_DIR_UNREADABLE', 'Un répertoire est <b>NON LISIBLE</b> et ne peut pas être vérifié !');
	define('_FPA_DI_PHP_FU', 'Fonctions désactivées');
	define('_FPA_FDSKSP', 'Espace disque libre');
	define('_FPA_NIMPLY', 'Non implementé pour');
	define('_FPA_PGSQL', 'PostgreSQL');
	define('_FPA_PMISS', 'Mot de passe manquant');
...
// fixed undefined index when server uses E_STRICT - Phil 9-20-12
	if (isset($_GET['act']) && $_GET['act'] == 'delete') {
		...
		chmod("fpa-fr.php", 0777);  // octal; correct value of mode
		// Delete the file.
		unlink('fpa-fr.php');
...
// Something went wrong and the script was not deleted so it must be removed manually so we tell the user to do so - Phil 8-07-12
		if (file_exists($filename)) {
			chmod("fpa-fr.php", 0644);  // octal; correct value of mode
			echo "<p><font color='Red' size='4'>Oups!</size></font color>";
			echo "<p><font color='Red' size='3'>Erreur lors du processus de suppression et le fichier </font color><font color='#000000'size='3'>$filename</font color></size><font color='Red'> existe toujours. </font color></p>";
			echo "<p><font color='Red' size='3'>Pour la sécurité du site, veuillez supprimer le fichier </font color><font color='#000000'size='3'>$filename</font color></size><font color='Red'> manuellement à l'aide de votre programme ftp.</font color></p>";
		} else {
			echo "<p><font color='#000000' size='3'>Merci d\'utiliser FPA. </font color></p>";
		}
		echo "<a href='$page'>Aller en page d\'accueil.</a>";
...
// end delete script
	...
	echo '<p>FPA Assistant mise à jour le: ' . _last_updated . '</p>';
...
//              }
	...
	if ($showElevated == '1') {
		...
		function getDirectory($path = '.', $level = 0) {
			...
			if (!$dh = @opendir($path)) { # Bernard: if a folder is NOT readable, without this check we get endless loop
			...
			if (function_exists('mysql_connect')) {
				...
				if ($result <> false) {
					if (mysql_num_rows($result) > 0) {
						for ($exset = array(); $row = mysql_fetch_array($result); $exset[] = $row)
							;
					}
					...
					$result = @mysql_query($sql);
					if (mysql_num_rows($result) > 0) {
						for ($tmpldef = array(); $row = mysql_fetch_array($result); $tmpldef[] = $row)
							;
					}
				}
			...
			if (function_exists('mysqli_connect')) {
				...
				if ($result <> false) {
					if ($result->num_rows > 0) {
						for ($exset = array(); $row = $result->fetch_assoc(); $exset[] = $row)
							;
					}
				}
				$sql = "select template, max(home) as home from " . $instance['configDBPREF'] . "template_styles group by template";
				...
				if ($result <> false) {
					if ($result->num_rows > 0) {
						for ($tmpldef = array(); $row = $result->fetch_assoc(); $tmpldef[] = $row)
							;
					}
				}
				if ($dBconn) {
		...
		<script type="text/javascript">
            function toggle2(showHideDiv, switchTextDiv) {
                ...
                if (ele.style.display == "block") {
                    ...
                    text.innerHTML = "<span style=\"font-size:12px;color:#4D8000;\"><span style=\"font-size:18px;color:#008000;\">&Theta;</span> Afficher <strong><?php echo _RES; ?></strong></span>";
                } else {
                    ele.style.display = "block";
                    text.innerHTML = "<span style=\"font-size:12px;color:#800000;\"><span style=\"font-size:20px;color:#800000;\">&otimes;</span> Masquer <strong><?php echo _RES; ?></strong></span>";
                }
            }
		</script>
	...
	<body>
		...
		echo '<div class="header-title" style="">' . _RES_withUrl . '</div>';
		...
		echo '<div class="header-column-title" style="text-align:center;"> FPA mis à jour le : ' . _last_updated . '</p>';
		echo '<br />';
...
//links for download that are found in the grey FPA box area.
		...
		<div style="margin: 0px auto;text-align:left;text-shadow: 1px 1px 1px #FFF; width:820px; background-color:#FFF;border:1px solid #999966; color:#4D8000; font-size:10px; font-family:arial; padding:5px;-moz-box-shadow: 3px 3px 3px #C0C0C0;-webkit-box-shadow: 3px 3px 3px #C0C0C0;box-shadow: 3px 3px 3px #C0C0C0;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;">
			<div id="headerDiv" class="">
				...
				<div id="titleText"><a id="myHeader" style="line-height:22px;text-decoration:none;color:#4D8000;" href="javascript:toggle2('myContent','myHeader');" ><span style="font-size:12px;color:#4D8000;"><span style="font-size:18px;color:#008000;">&Theta;</span> Afficher <strong><?php echo _RES; ?></strong></span></a></div>
			...
			<div id="contentDiv" style="">
				...
				<div id="myContent" style="display: <?php echo $displayMode; ?>;">
					...
					<div class="half-section-container" style="width:730px;">
						...
						<div class="half-section-information-left" style="width:340px;padding-top:10px;padding-bottom:10px;border-color:#CCC;box-shadow: inset 3px 3px 3px #C0C0C0;-webkit-box-shadow: inset 3px 3px 3px #C0C0C0;background-color:transparent!important;">
							...
							<div class="normal-note" style="min-height:145px;padding-left:10px;">
								<strong>Informations optionnelles</strong><br /><br />
								...
								<form method="post" name="postDetails" id="postDetails">
									...
									if (isset($phpenv['phpLASTERR'])) {
										echo '<div style="text-align:right;padding:2px;"><div class="warn-text" style="text-align:left;width:120px;float:left;">Dernières erreurs PHP:</div> <input class="normal-note" style="color: #800000;background-color: #FFFFCC;width:175px;font-size:9px;" type="text" value="' . $phpenv['phpLASTERR'] . '" name="probMSG2" /><br /><span class="normal" style="font-size:8px;">Remplissage auto par le journal d\'erreurs php (log)&nbsp;&nbsp;</span></div>';
									} else {
							...
							<div class="normal-note" style="min-height:145px;">
								...
								<div style = "margin: 0px auto; width:90%;text-align:center;margin-top:10px;">
									...
									<div class="normal" style="text-shadow:none!important;margin-left:10px;float:left;width:95%;text-align:left;">
										<br />
										<span class="ok"><?php echo _FPA_INS_5b; ?></span>
									</div>
					...
					if (@$_POST['doIT'] == '1' && @$_POST['markdownOutput'] == 0) {


						/** BBCode for the Joomla! Forum
						 * *************************************************************************************** */
// --- start of FR forum code
						/* begin Original version for optional infos
						  if ( $_POST['probDSC'] ) { echo '[quote="'. _FPA_PROB_DSC .' :: '. _RES .' (v'. _RES_VERSION .') : '. @date_fr("j F Y") .']'. $_POST['probDSC']; }

						  if ( $_POST['probMSG1'] ) { echo '[quote="'. _FPA_PROB_MSG .' :: '. _RES .' (v'. _RES_VERSION .') : '. @date_fr("j F Y") .']'. $_POST['probMSG1']; }

						  if ( $phpenv['phpLASTERR'] AND $_POST['probMSG2'] ) { echo '[quote="'. _FPA_LAST .' PHP '. _FPA_ER .' :: '. _RES .' (v'. _RES_VERSION .') : '. @date_fr("j F Y") .'"][color=#800000]'. $_POST['probMSG2'] .'[/color][/size]';
						  } elseif ( !@$phpenv['phpLASTERROR'] AND $_POST['probMSG2'] ) { echo '[quote="'. _FPA_PROB_MSG .' :: '. _RES .' (v'. _RES_VERSION .') : '. @date_fr("j F Y") .']'. $_POST['probMSG2']; }

						  if ( $_POST['probACT'] ) { echo '[quote="'. _FPA_PROB_ACT .' '. _FPA_BY .' '. _RES .' (v'. _RES_VERSION .') '. @date_fr("j F Y") .']'. $_POST['probACT']; }

						  echo '[quote="'. _RES .' (v'. _RES_VERSION .') : '. @date_fr("j F Y") .']';
						  begin Original version  for optional infos */
						...
						// optional infos
						if ($_POST['probDSC']) {
							echo '[b]' . _FPA_PROB_DSC . '[/b] :: ' . $_POST['probDSC'];
							echo "\r\n";
						}
						if ($_POST['probMSG1']) {
							echo '[b]' . _FPA_PROB_MSG . '[/b] :: ' . $_POST['probMSG1'];
							echo "\r\n";
						}

						if ($phpenv['phpLASTERR'] AND $_POST['probMSG2']) {
							echo '[b]' . _FPA_LAST . ' PHP ' . _FPA_ER . '[/b] :: [color=#800000]' . $_POST['probMSG2'] . '[/color]';
							echo "\r\n";
						} elseif (!@$phpenv['phpLASTERROR'] AND $_POST['probMSG2']) {
							echo '[b]' . _FPA_PROB_MSG . '[/b] :: ' . $_POST['probMSG2'];
							echo "\r\n";
						}

						if ($_POST['probACT']) {
							echo '[b]' . _FPA_PROB_ACT . '[/b] :: ' . $_POST['probACT'];
							echo "\r\n";
						}
...
//					echo '#### '. _FPA_BASIC .' '. _FPA_ENVIRO .' ::"]';
						...
						if ($instance['instanceFOUND'] == _FPA_Y) {
							echo '[color=Blue]' . $instance['cmsPRODUCT'] . ' [b]' . $instance['cmsRELEASE'] . '.' . $instance['cmsDEVLEVEL'] . '[/b]-' . $instance['cmsDEVSTATUS'] . ' (' . $instance['cmsCODENAME'] . ') ' . $instance['cmsRELDATE'] . '[/color]';
						} else {
						...
						if ($instance['instanceCONFIGURED'] == _FPA_Y) {
							...
							if ($instance['configWRITABLE'] == _FPA_Y) {
								echo '[color=Green]' . _FPA_WRITABLE . '[/color] (';
							} else {
								echo _FPA_RO . ' (';
							}
							...
							if (($instance['configSITEHTWC'] == _FPA_N AND $instance['configSEFRWRITE'] == '1') OR ( $instance['configSITEHTWC'] == _FPA_N AND $instance['configSEFRWRITE'] == 'true' )) {
								echo '[color=orange]' . $instance['configSITEHTWC'] . ' (ReWrite Enabled but no .htaccess?)[/color] | ';
							} elseif ($instance['configSITEHTWC'] == _FPA_Y) {
								echo '[color=Green]' . $instance['configSITEHTWC'] . '[/color] | ';
							} elseif ($instance['configSITEHTWC'] == _FPA_N) {
						...
						if (version_compare($phpenv['phpVERSION'], '5.0.0', '<')) {
							echo '[color=Red]' . $phpenv['phpVERSION'] . '[/color] | ';
						} else {
						...
						if ($phpenv['phpSESSIONPATHWRITABLE'] == _FPA_Y) {
							echo '[color=Green]' . $phpenv['phpSESSIONPATHWRITABLE'] . '[/color] | ';
						} elseif ($phpenv['phpSESSIONPATHWRITABLE'] == _FPA_N) {
							echo '[color=Red]' . $phpenv['phpSESSIONPATHWRITABLE'] . '[/color] | ';
						} else {
						...
						if ($database['dbDOCHECKS'] == _FPA_N) {
							...
							if (@$instance['configDBCREDOK'] != _FPA_Y AND $instance['instanceFOUND'] == _FPA_Y) {
								...
								if (@$instance['configDBNAME'] == '') {
									echo '[color=orange][b]Database Name[/b] missing[/color] |';
								}
							...
							if ($_POST['showProtected'] > '1') {
								echo '[b]' . _FPA_HOST . ':[/b]  [color=orange]--' . _FPA_HIDDEN . '--[/color] ([color=orange]--' . _FPA_HIDDEN . '--[/color]) | ';
							} else {
								echo '[b]' . _FPA_HOST . ':[/b] ' . $instance['configDBHOST'] . ' (' . $database['dbHOSTINFO'] . ') | ';
							}
						...
						echo "\r\n\r\n";
						//echo '#### '. _FPA_DETAILED .' '. _FPA_ENVIRO .' ::"]';
						...
						echo "\r\n";
						echo '[b]' . _FPA_POTOI . ':[/b] ';
						if ($phpenv['phpOWNERPROB'] == _FPA_Y) {
							echo '[color=Red]';
						} elseif ($phpenv['phpOWNERPROB'] == _FPA_N) {
							echo '[color=Green]';
						} else {
							echo '[color=orange]';
						}
...
//						echo '#### Database Information ::"]';
						...
						if ($instance['instanceFOUND'] == _FPA_Y AND ( @$_POST['showComponents'] == '1' OR @ $_POST['showModules'] == '1' OR @ $_POST['showPlugins'] == '1' )) {
							...
							if ($instance['instanceFOUND'] == _FPA_Y) {
								echo "\r\n\r\n";
//							echo '#### '. _FPA_TMPL_TITLE .' Discovered ::"]';
...
//					echo '#### '. _FPA_BASIC .' '. _FPA_ENVIRO .' ::"]';
						...
						if ($instance['instanceFOUND'] == _FPA_Y) {
							...
							echo '<span style="color:darkOrange">' . _FPA_NF . '</span>';
						}

						// Multiple version file warning
						if ($vFileSum > 1) {
							echo "\r\n";
							echo '<span style="color:red">**' . _FPA_MVFW . '**</span>';
						}

						// Joomla! platform details
						if (@$instance['platformPRODUCT']) {
							echo "\r\n";
							echo '**' . _FPA_APP . ' ' . _FPA_PLATFORM . ' :: ** ' . @$instance['platformPRODUCT'] . ' **' . @$instance['platformRELEASE'] . '.' . @$instance['platformDEVLEVEL'] . '**-' . @$instance['platformDEVSTATUS'] . ' (' . @$instance['platformCODENAME'] . ') ' . @$instance['platformRELDATE'];
						}

						echo "\r\n";

						echo '**' . _FPA_APP . ' ' . _FPA_YC . ' :: **';
						if ($instance['instanceCONFIGURED'] == _FPA_Y) {
							echo _FPA_Y . ' | ';
							...
							echo "\r\n";
							echo '**Offline:** ' . $instance['configOFFLINE'] . ' | **SEF:** ' . $instance['configSEF'] . ' | **SEF Suffix:** ' . $instance['configSEFSUFFIX'] . ' | **SEF ReWrite:** ' . $instance['configSEFRWRITE'] . ' | ';
							echo '**.htaccess/web.config:** ';

							if (($instance['configSITEHTWC'] == _FPA_N AND $instance['configSEFRWRITE'] == '1') OR ( $instance['configSITEHTWC'] == _FPA_N AND $instance['configSEFRWRITE'] == 'true' )) {
								echo '<span style="color:darkOrange">' . $instance['configSITEHTWC'] . ' (ReWrite Enabled but no .htaccess?)</span> | ';
							} elseif ($instance['configSITEHTWC'] == _FPA_Y) {
								echo '<span style="color:green">' . $instance['configSITEHTWC'] . '</span> | ';
							} elseif ($instance['configSITEHTWC'] == _FPA_N) {
								echo '<span style="color:darkOrange">' . $instance['configSITEHTWC'] . '</span> | ';
							}

							echo '**GZip:** ' . $instance['configGZIP'] . ' | **Cache:** ' . $instance['configCACHING'] . ' | **CacheTime:** ' . $instance['configCACHETIME'] . ' | **CacheHandler:** ' . $instance['configCACHEHANDLER'] . ' | **CachePlatformPrefix:** ' . $instance['configCACHEPLFPFX'] . ' | **FTP Layer:** ' . $instance['configFTP'] . ' | **Proxy:** ' . $instance['configPROXY'] . ' | **LiveSite:** ' . $instance['configLIVESITE'] . ' | **Session lifetime:** ' . $instance['configLIFETIME'] . ' | **Session handler:** ' . $instance['configSESSHAND'] . ' | **Shared sessions:** ' . $instance['configSHASESS'] . ' | **SSL:** ' . $instance['configSSL'] . ' | **Error Reporting:** ' . $instance['configERRORREP'] . ' | **Site Debug:** ' . $instance['configSITEDEBUG'] . ' | ';

							if (version_compare($instance['cmsRELEASE'], '1.5', '>=')) {
								echo '**Language Debug:** ' . $instance['configLANGDEBUG'] . ' | ';
								echo '**Default Access:** ' . $instance['configACCESS'] . ' | **Unicode Slugs:** ' . $instance['configUNICODE'] . ' | **dbConnection Type:** ' . $instance['configDBTYPE'] . ' | ';
							}

							echo '**' . _FPA_SUPPHP . ' J! ' . @$instance['cmsRELEASE'] . '.' . @$instance['cmsDEVLEVEL'] . ': **';
							if ($snapshot['phpSUP4J'] == _FPA_Y) {
								echo '<span style="color:green">';
							} else {
								echo '<span style="color:red">';
							}
							echo $snapshot['phpSUP4J'] . '</span> | ';
							...
							echo $instance['configDBCREDOK'] . '</span> | ';
						} else {
							echo '<span style="color:darkOrange">' . _FPA_NF . '</span>';
						}
						...
						if ($showProtected <> 1) {
							echo '## ' . _FPA_HOST . ' ' . _FPA_CFG;
							echo "\r\n";
							echo '**OS:** ' . $system['sysPLATOS'] . ' |  **OS ' . _FPA_VER . ':** ' . $system['sysPLATREL'] . ' | **' . _FPA_TEC . ':** ' . $system['sysPLATTECH'] . ' | **' . _FPA_WSVR . ':** ' . $system['sysSERVSIG'] . ' | **Encoding:** ' . $system['sysENCODING'] . ' | **' . _FPA_DROOT . ':** ' . '<span style="color:darkOrange">--' . _FPA_HIDDEN . '--</span>' . ' | **' . _FPA_SYS . ' TMP ' . _FPA_WRITABLE . ':** ';
							if ($system['sysTMPDIRWRITABLE'] == _FPA_Y) {
								echo '<span style="color:green">';
							} else {
								echo '<span style="color:red">';
							}
							echo $system['sysTMPDIRWRITABLE'] . '</span> | ';
						} else {
							echo '**' . _FPA_HOST . ' ' . _FPA_CFG . ' :: OS:** ' . $system['sysPLATOS'] . ' |  **OS ' . _FPA_VER . ':** ' . $system['sysPLATREL'] . ' | **' . _FPA_TEC . ':** ' . $system['sysPLATTECH'] . ' | **' . _FPA_WSVR . ':** ' . $system['sysSERVSIG'] . ' | **Encoding:** ' . $system['sysENCODING'] . ' | **' . _FPA_DROOT . ':** ' . $system['sysDOCROOT'] . ' | **' . _FPA_SYS . ' TMP ' . _FPA_WRITABLE . ':** ';
							if ($system['sysTMPDIRWRITABLE'] == _FPA_Y) {
								echo '<span style="color:green">';
							} else {
								echo '<span style="color:red">';
						...
						if (function_exists('disk_free_space')) {
							$free_space = sprintf('%.2f', disk_free_space('./') / 1073741824);
							$system['sysFREESPACE'] = $free_space . ' GiB';
							echo '**  ' . _FPA_FDSKSP . ' :** ' . $system['sysFREESPACE'] . ' |';
						} else {
							echo '**  ' . _FPA_FDSKSP . ' :** ' . _FPA_U . ' |';
						}
						...
						echo '**' . _FPA_VER . '** : ';
						if (version_compare($phpenv['phpVERSION'], '5.0.0', '<')) {
							echo '<span style="color:red">' . $phpenv['phpVERSION'] . '</span> | ';
						} else {
							echo '**' . $phpenv['phpVERSION'] . '** | ';
						}

						echo '**PHP API:** ';
						if ($phpenv['phpAPI'] == 'apache2handler') {
							echo '<span style="color:darkOrange">' . $phpenv['phpAPI'] . '</span> | ';
						} else {
							echo '**' . $phpenv['phpAPI'] . '** | ';
						}

						echo '**Session Path ' . _FPA_WRITABLE . ':** ';
						if ($phpenv['phpSESSIONPATHWRITABLE'] == _FPA_Y) {
							echo '<span style="color:green">' . $phpenv['phpSESSIONPATHWRITABLE'] . '</span> | ';
						} elseif ($phpenv['phpSESSIONPATHWRITABLE'] == _FPA_N) {
							echo '<span style="color:red">' . $phpenv['phpSESSIONPATHWRITABLE'] . '</span> | ';
						} else {
							echo '<span style="color:darkOrange">' . $phpenv['phpSESSIONPATHWRITABLE'] . '</span> | ';
						}

						echo '**Display Errors:** ' . $phpenv['phpERRORDISPLAY'] . ' | **Error Reporting:** ' . $phpenv['phpERRORREPORT'] . ' | **Log Errors To:** ' . $phpenv['phpERRLOGFILE'] . ' | **Last Known Error:** ' . @$phpenv['phpLASTERRDATE'] . ' | **Register Globals:** ' . $phpenv['phpREGGLOBAL'] . ' | **Magic Quotes:** ' . $phpenv['phpMAGICQUOTES'] . ' | **Safe Mode:** ' . $phpenv['phpSAFEMODE'] . ' | **Open Base:** ' . $phpenv['phpOPENBASE'] . ' | **Uploads:** ' . $phpenv['phpUPLOADS'] . ' | **Max. Upload Size:** ' . $phpenv['phpMAXUPSIZE'] . ' | **Max. POST Size:** ' . $phpenv['phpMAXPOSTSIZE'] . ' | **Max. Input Time:** ' . $phpenv['phpMAXINPUTTIME'] . ' | **Max. Execution Time:** ' . $phpenv['phpMAXEXECTIME'] . ' | **Memory Limit:** ' . $phpenv['phpMEMLIMIT'];

						echo "\r\n\r\n";

						echo '## Database ' . _FPA_CFG;
						echo "\r\n";
						if ($database['dbDOCHECKS'] == _FPA_N) {
							echo '<span style="color:darkOrange">' . _FPA_DB . ' ' . _FPA_DBCREDINC . '</span> ' . _FPA_NODISPLAY;
							echo "\r\n";

							if (@$instance['configDBCREDOK'] != _FPA_Y AND $instance['instanceFOUND'] == _FPA_Y) {
								echo '<span style="color:red">**' . _FPA_MISSINGCRED . ': **</span> ';

								if (@$instance['configDBTYPE'] == '') {
									echo '<span style="color:darkOrange">**Connection Type** missing</span> | ';
								}
								if (@$instance['configDBNAME'] == '') {
									echo '<span style="color:darkOrange">**Database Name** missing</span> |';
								}
								if (@$instance['configDBHOST'] == '') {
									echo '<span style="color:darkOrange">**MySQL Host** missing</span> | ';
								}
								if (@$instance['configDBPREF'] == '') {
									echo '<span style="color:darkOrange">**Table Prefix** missing</span> | ';
								}
								if (@$instance['configDBUSER'] == '') {
									echo '<span style="color:darkOrange">**Database Username** missing</span> | ';
								}
								if (@$instance['configDBPASS'] == '') {
									echo '<span style="color:darkOrange">**Database Password** missing</span> |';
								}
							}
						} elseif (@$database['dbERROR'] != _FPA_N) {
							echo '**' . _FPA_ECON . ':** ';
							...
							echo '** Localhost:** ' . $database['dbLOCAL'] . ' | **' . _FPA_TCOL . ':** ' . $database['dbCOLLATION'] . ' (**' . _FPA_CHARS . ':** ' . $database['dbCHARSET'] . ') | **' . _FPA_DB . ' ' . _FPA_TSIZ . ':** ' . $database['dbSIZE'] . ' | **#' . _FPA_OF . '&nbsp' . _FPA_TABLE . ':&nbsp** ' . $database['dbTABLECOUNT'];
						}
						...
						foreach ($phpextensions as $key => $show) {
							...
							if ($show != $phpextensions['ARRNAME']) {
								...
								// find the requirements and mark them as present or missing
								if ($key == 'libxml' OR $key == 'xml' OR $key == 'zip' OR $key == 'openssl' OR $key == 'zlib' OR $key == 'curl' OR $key == 'iconv' OR $key == 'mbstring' OR $key == 'mysql' OR $key == 'mysqli' OR $key == 'pdo_mysql' OR $key == 'mcrypt' OR $key == 'suhosin' OR $key == 'cgi' OR $key == 'cgi-fcgi') {
									echo '<span style="color:green">**' . $key . '**</span> (' . $show . ') | ';
								} elseif ($key == 'apache2handler') {
									echo '<span style="color:darkOrange">' . $key . '</span> (' . $show . ') | ';
								} else {
									echo $key . ' (' . $show . ') | ';
								}
							} // endif !arrname
						...
						echo '**' . _FPA_POTME . ' :: **';
						foreach ($phpreq as $missingkey => $missing) {
							echo '<span style="color:darkOrange">' . $missingkey . '</span> | ';
						}
						...
						echo "\r\n\r\n";
						echo '## Switch User ' . _FPA_ENVIRO . ' (Experimental)';
						echo "\r\n";
						echo '** PHP CGI:** ' . $phpenv['phpCGI'] . ' | **Server SU:** ' . $phpenv['phpAPACHESUEXEC'] . ' |  **PHP SU:** ' . $phpenv['phpPHPSUEXEC'] . ' |   **Custom SU (LiteSpeed/Cloud/Grid):** ' . $phpenv['phpCUSTOMSU'];
						echo "\r\n";
						echo '**' . _FPA_POTOI . ':** ';
						if ($phpenv['phpOWNERPROB'] == _FPA_Y) {
							echo '<span style="color:red">';
							...
							foreach ($apachemodules as $key => $show) {
								...
								if ($show != $apachemodules['ARRNAME']) {
									...
									if ($show == 'mod_rewrite' OR $show == 'mod_cgi' OR $show == 'mod_cgid' OR $show == 'mod_expires' OR $show == 'mod_deflate' OR $show == 'mod_auth') {
										...
										echo '<span style="color:red">' . $show . '</span> | ';
									} else {
										echo $show . ' | ';
									}
								} // endif !arrname
...
//							echo '#### Folder Permissions ::"]';
							...
							foreach ($folders as $i => $show) {
								...
								if ($show != $folders['ARRNAME']) {
									...
									if (substr($modecheck[$show]['mode'], 1, 1) == '7' OR substr($modecheck[$show]['mode'], 2, 1) == '7') {
										echo '<span style="color:red">' . $modecheck[$show]['mode'] . '</span>) | ';
									} else {
										echo $modecheck[$show]['mode'] . ') | ';
									}
								}
							...
							if (@$_POST['showElevated'] == '1') {
								...
								$limitCount = '0';
								echo '## ' . _FPA_ELEVPERM_TITLE . ' (' . _FPA_FIRST . ' 10)';
								echo "\r\n";
									...
									if ($limitCount >= '11') {
										...
										if ($show != $elevated['ARRNAME']) {
											...
											if ($key != 'None') {
												...
												if (substr($show['mode'], 1, 1) == '7' OR substr($show['mode'], 2, 1) == '7') {
													echo '<span style="color:red">' . $show['mode'] . '</span>) | ';
												} else {
													echo $show['mode'] . ') | ';
												}
											}
...
//					echo '#### Extensions Discovered ::"]';
							...
							if ($_POST['showProtected'] == '3') {
								echo '<span style="color:darkOrange">**Strict** Information Privacy was selected.</span> Nothing to display.';
							} else {
								...
								if (@$_POST['showComponents'] == '1') {
									if ($showCoreEx == 1) {
										...
										foreach ($component['SITE'] as $key => $show) {
											...
											if ($show['type'] == _FPA_JCORE) {
												$tmp .= $extenabled . ' | ' . $show['name'] . ' | ' . $show['version'] . ' | ' . $show['author'];
												$tmp .= "\r\n";
											}
										}
										if ($tmp > '') {
											echo '### ' . _FPA_EXTCOM_TITLE . ' ' . _FPA_SITE . ' ' . _FPA_JCORE;
											echo "\r\n";
											echo "actif | nom | version | auteur  \r\n --- | --- | --- | :---: \r\n";
											echo $tmp;
											echo "\r\n";
										}
									}
									// component site tierce
									$tmp = '';
									foreach ($component['SITE'] as $key => $show) {
										if (isset($exset[0]['name'])) {
											$extarrkey = recursive_array_search($show['name'], $exset);
									...
									if ($tmp > '') {
										echo '### ' . _FPA_EXTCOM_TITLE . ' ' . _FPA_SITE . ' ' . _FPA_3PD;
										echo "\r\n";
										echo "actif | nom | version | auteur  \r\n --- | --- | --- | :---: \r\n";
										echo $tmp;
										echo "\r\n";
								...
								if (@$_POST['showModules'] == '1') {
									...
									if ($showCoreEx == 1) {
										...
										if ($tmp > '') {
											echo '### ' . _FPA_EXTMOD_TITLE . ' ' . _FPA_SITE . ' ' . _FPA_JCORE;
											echo "\r\n";
											echo "actif | nom | version | auteur  \r\n --- | --- | --- | :---: \r\n";
											echo $tmp;
											echo "\r\n";
									...
									if ($tmp > '') {
										echo '### ' . _FPA_EXTMOD_TITLE . ' ' . _FPA_SITE . ' ' . _FPA_3PD;
										echo "\r\n";
										echo "actif | nom | version | auteur  \r\n --- | --- | --- | :---: \r\n";
										echo $tmp;
										echo "\r\n";
									...
									if ($showCoreEx == 1) {
										...
										if ($tmp > '') {
											echo '### ' . _FPA_EXTMOD_TITLE . ' ' . _FPA_ADMIN . ' ' . _FPA_JCORE;
											echo "\r\n";
											echo "actif | nom | version | auteur  \r\n --- | --- | --- | :---: \r\n";
											echo $tmp;
											echo "\r\n";
									...
									if ($tmp > '') {
										echo '### ' . _FPA_EXTMOD_TITLE . ' ' . _FPA_ADMIN . ' ' . _FPA_3PD;
										echo "\r\n";
										echo "actif | nom | version | auteur  \r\n --- | --- | --- | :---: \r\n";
										echo $tmp;
										echo "\r\n";
								...
								if (@$_POST['showPlugins'] == '1') {
									...
									if ($showCoreEx == 1) {
										...
										if ($tmp > '') {
											echo '### ' . _FPA_EXTPLG_TITLE . ' ' . _FPA_SITE . ' ' . _FPA_JCORE;
											echo "\r\n";
											echo "actif | nom | version | auteur  \r\n --- | --- | --- | :---: \r\n";
											echo $tmp;
											echo "\r\n";
									...
									if ($tmp > '') {
										echo '### ' . _FPA_EXTPLG_TITLE . ' ' . _FPA_SITE . ' ' . _FPA_3PD;
										echo "\r\n";
										echo "actif | nom | version | auteur  \r\n --- | --- | --- | :---: \r\n";
										echo $tmp;
										echo "\r\n";
							...
							if ($instance['instanceFOUND'] == _FPA_Y) {
								...
								if ($_POST['showProtected'] == '3') {
									echo '<span style="color:darkOrange">**' . _FPA_STRICT . '** ' . _FPA_INFOPRI . '</span> ' . _FPA_NODISPLAY;
								} else {
									// TEMPLATE SITE
									$tmp = '';
									foreach ($template['SITE'] as $key => $show) {
										...
										// always displays core template if by default
										if ($show['type'] == _FPA_3PD OR $showCoreEx == 1 OR $deftempl == 1) {
											if ($show['type'] == _FPA_3PD) {
												$tmp .= $extenabled . ' | ' . $bldop . $show['name'] . $bldcl . ' | ' . $show['version'] . ' | ' . $show['author'];
											} else {
												$tmp .= $extenabled . ' | ' . $bldop . $show['name'] . $bldcl . ' (core)| ' . $show['version'] . ' | ' . $show['author'];
											}
											$tmp .= "\r\n";
										}
									}
									if ($tmp > '') {
										echo '### ' . _FPA_TMPL_TITLE . ' ' . _FPA_SITE;
										echo "\r\n";
										echo "actif | nom | version | auteur  \r\n --- | --- | --- | :---: \r\n";
										echo $tmp;
										echo "\r\n";
									...
									if ($tmp > '') {
										echo '### ' . _FPA_TMPL_TITLE . ' ' . _FPA_ADMIN;
										echo "\r\n";
										echo "actif | nom | version | auteur  \r\n --- | --- | --- | :---: \r\n";
										echo $tmp;
										echo "\r\n";
		...
		echo '<div class="section-title" style="text-align:center;">' . $instance['ARRNAME'] . ' :: Détails</div>';
		...
		if (@$instance['configDBCREDOK'] != _FPA_Y AND $instance['instanceFOUND'] == _FPA_Y) {
			...
			if (@$instance['configDBTYPE'] == '') {
				echo '<span class="warn-text" style="font-size:9px;font-weight:normal;text-transform:none;">&nbsp;<b>' . _FPA_CONT . '</b> ' . _FPA_NF . '</span>';
			}
			if (@$instance['configDBHOST'] == '') {
				echo '<span class="warn-text" style="font-size:9px;font-weight:normal;text-transform:none;">&nbsp;MySQL <b>' . _FPA_HNAME . '</b> ' . _FPA_NF . '</span>';
			}
			if (@$instance['configDBNAME'] == '') {
				echo '<span class="warn-text" style="font-size:9px;font-weight:normal;text-transform:none;">&nbsp;' . _FPA_DB . ' <b>' . _FPA_TNAM . '</b> ' . _FPA_NF . '</span>';
			}
			if (@$instance['configDBPREF'] == '') {
				echo '<span class="warn-text" style="font-size:9px;font-weight:normal;text-transform:none;">&nbsp;<b>' . _FPA_TBL . ' Prefix</b> ' . _FPA_NF . '</span>';
			}
			if (@$instance['configDBUSER'] == '') {
				echo '<span class="warn-text" style="font-size:9px;font-weight:normal;text-transform:none;">&nbsp;' . _FPA_DB . ' <b>' . _FPA_USER . '</b> ' . _FPA_NF . '</span>';
			}
			if (@$instance['configDBPASS'] == '') {
				echo '<span class="warn-text" style="font-size:9px;font-weight:normal;text-transform:none;">&nbsp;' . _FPA_DB . ' <b>' . _FPA_PASS . '</b> ' . _FPA_NF . '</span>';
			}
		...
		echo '<div class="mini-content-box-small" style="">';
		echo '<div style="line-height:10px;font-size:8px;color:#404040;text-shadow: #fff 1px 1px 1px;width:99%;border-bottom: 1px solid #ccebeb;font-weight:bold;padding:1px;padding-top:0px;padding-right:0px;padding-bottom:2px;text-transform:uppercase;">Chemin Open Base:<div style="float:right;">';
		...
		echo '<div class="mini-content-box-small" style="">';
		echo '<div style="line-height:10px;font-size:8px;color:#404040;text-shadow: #fff 1px 1px 1px;width:99%;border-bottom: 1px solid #ccebeb;font-weight:bold;padding:1px;padding-top:0px;padding-right:0px;padding-bottom:2px;text-transform:uppercase;">Chemin de Session:<div style="float:right;">';
		...
		echo '<div class="mini-content-box-small" style="">';
		echo '<div style="line-height:10px;font-size:8px;color:#404040;text-shadow: #fff 1px 1px 1px;width:99%;border-bottom: 1px solid #ccebeb;font-weight:bold;padding:1px;padding-top:0px;padding-right:0px;padding-bottom:2px;text-transform:uppercase;">Chemin de Session ' . _FPA_WRITABLE . ':<div style="float:right;">';
		...
		echo '<div class="mini-content-box-small" style="">';
		echo '<div style="line-height:10px;font-size:8px;color:#404040;text-shadow: #fff 1px 1px 1px;width:99%;border-bottom: 1px solid #ccebeb;font-weight:bold;padding:1px;padding-top:0px;padding-right:0px;padding-bottom:2px;text-transform:uppercase;">Chemin fichier INI:<div style="float:right;">';
		...
		if ($phpenv['phpLASTERR']) {
			...
			echo '<span class="ok" style="margin:5px;text-transform:none;font-weight:normal;font-size:9px;padding:2px;">Aucune</span>';
		}
				...
				foreach ($elevated as $key => $show) {
					...
					if ($show != $elevated['ARRNAME']) {
						...
						if ($showProtected <= 2) {
							...
							if ($key == 'None') {
								echo '<span style="color:color:#008000"><b>' . $key . '</b></span>';
							} else {
								echo $key . '/ (';
							}
						} else {
